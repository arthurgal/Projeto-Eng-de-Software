...
export default function PhonesToSell() {
  return (
    <div className="div-padrao">
      ...
      <div className='div-main'>
         <div className='div-title'>
            ...
            <a href="/cadastarProduto" className='button-novo-produto' >Carrinho</a>
         </div>
         <div className='div-listing'>
                <ProdutoAvenda id= {3} nome = "Sansung" preco = "39999" descricao = "celular muito bom"></ProdutoAvenda>
         </div>
      </div>
    </div>
  )
